...
if (!isHelpOnly && !fs.existsSync(playwrightPkg)) {
  if (isVsCodeMode) {
    console.error("AI Free VS Code extension is missing bundled dependencies.");
    console.error("Reinstall the extension from Marketplace or install a newer VSIX build.");
    process.exit(1);
  }
