...
export const COMMAND_CATALOG = {
  ...
  python3: { description: "Python на macOS, Linux, Windows и из .venv проекта", risk: "low", enabledByDefault: true },
...
function normalizeCommandPermissions(rawPermissions = {}) {
  return {
    ...
    // Full-assistant mode is permissive for inspection and ordinary work, but
    // deletion and external mutations always start locked until the owner opts in.
    allowDestructiveActions: rawPermissions?.allowDestructiveActions === true,
    allowExternalWrites: rawPermissions?.allowExternalWrites === true,
  };
}
